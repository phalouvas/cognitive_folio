...
def build_portfolio_financial_summary(portfolio, holdings):
	...
	portfolio_summary = [
		...
		f"Weighted Gross Margin: {aggregate['weighted_gross_margin']:.2f}%",
		f"Weighted Operating Margin: {aggregate['weighted_operating_margin']:.2f}%",
		f"Weighted Net Margin: {aggregate['weighted_net_margin']:.2f}%",
